...
export default class EmailEditor extends Component {
    constructor(props) {
        super(props);
				...
				const html = '<p className="rdw-center-aligned-block"><strong><span style="text-decoration: underline" id="quote"><table><tr><td>mukesh</td></tr></table>QUOTATION</span></strong></p>';
